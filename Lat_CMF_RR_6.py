...
file = open("Test1_MACE_AV__N_atom_"+str(N_atom)+"_Cluster_size_"+str(Atom_cutoff)+"_Max_step_"+str(max_step)+"_Tspan_"+str(tspan[0])+"-"+str(tspan[-1])+"_Signature_"+str(Random_signature)+".txt", "w+")
...
file = open("Test2_MACE_AV__N_atom_"+str(N_atom)+"_Cluster_size_"+str(Atom_cutoff)+"_Max_step_"+str(max_step)+"_Tspan_"+str(tspan[0])+"-"+str(tspan[-1])+"_Signature_"+str(Random_signature)+".txt", "w+")
#np.savetxt(file, Res_conc, delimiter=',')
file.write('\n')
file.write('\n')
file.close()   
...
file = open("Test3_MACE_AV__N_atom_"+str(N_atom)+"_Cluster_size_"+str(Atom_cutoff)+"_Max_step_"+str(max_step)+"_Tspan_"+str(tspan[0,0])+"-"+str(tspan[-1,0])+"_Signature_"+str(Random_signature)+".txt", "w+")
#np.savetxt(file, Res_conc, delimiter=',')
file.write('\n')
file.write('\n')
file.close()   
